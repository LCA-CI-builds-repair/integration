...
class HacsData:
    ...
    def async_restore_repository(self, entry: str, repository_data: dict[str, Any]):
        ...
        repository.data.selected_tag = repository_data.get("selected_tag", None)
        repository.data.show_beta = repository_data.get("show_beta", False)
        repository.data.last_version = repository_data.get("last_version", None)
        repository.data.last_commit = repository_data.get("last_commit", None)
        repository.data.installed_version = repository_data.get("installed_version", None)
