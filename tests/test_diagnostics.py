"""Test thfrom custom_components.hacs.diagnostics import async_get_config_entry_diagnostics
...
from aiogithubapi.models import GitHubRateLimitModel, GitHubResponseModel

from tests.common import TOKEN, REDACTED
...
async def test_diagnostics_with_exception(
    ...
    with patch(
        ...
        diagnostics = await async_get_config_entry_diagnostics(hass, config_entry) unittest.mock import MagicMock, patch
